...
# Coverage Profiles
```{r coverage, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r coverage_transcript, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r coverage_exon, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r coverage_exon-intron, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r coverage_intron, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r coverage_promoter, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r coverage_UTR5, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r coverage_UTR3, echo=FALSE, warning=FALSE, message=FALSE}
