...
```{r get_table_of_genes_tabcap, echo=FALSE, results='asis', eval=FALSE}
...
```{r get_table_of_genes, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
