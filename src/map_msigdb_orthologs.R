##given the list of MSIGDB gene sets containing ENTREZ identifiers and orthologous groups from EGGNOG; map human genes from MSIGDB into mouse (mm9), fly(dm3), and worm(ce6) via orthologouse relationships. 
